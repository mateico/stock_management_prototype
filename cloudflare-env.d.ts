/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: ce1dae9c98e421806891e67a5afdf78b)
...
interface __BaseEnv_CloudflareEnv {
	...
	GOOGLE_SHEETS_PRIVATE_KEY_ID: string;
	GOOGLE_SHEETS_CLIENT_ID: string;
	GOOGLE_SHEETS_CERT_URL: string;
	SHEET_UPDATES: DurableObjectNamespace<import("./custom-worker").SheetUpdates>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./custom-worker");
		durableNamespaces: "SheetUpdates";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "GOOGLE_SHEETS_PRIVATE_KEY" | "GOOGLE_SHEETS_CLIENT_EMAIL" | "GOOGLE_SHEETS_SPREADSHEET_ID" | "GOOGLE_SHEETS_PROJECT_ID" | "GOOGLE_SHEETS_PRIVATE_KEY_ID" | "GOOGLE_SHEETS_CLIENT_ID" | "GOOGLE_SHEETS_CERT_URL">> {}
}
